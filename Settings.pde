  ...
  Settings(String _s) {
    try {
      ...
      for (int i=0;i<settings.data.length;i++) {
        if (settings.data[i].equals("persistence")) persistence = setBoolean(settings.data[i+1]);
        if (settings.data[i].equals("renderFrames")) renderFrames = setBoolean(settings.data[i+1]);
        if (settings.data[i].equals("renderKeys")) renderKeys = setBoolean(settings.data[i+1]);
        ...
        if (settings.data[i].equals("masterSize")) masterSize = setInt(settings.data[i+1]);
        if (settings.data[i].equals("numColumns")) numColumns = setInt(settings.data[i+1]);
        if (settings.data[i].equals("numRows")) numRows = setInt(settings.data[i+1]);
